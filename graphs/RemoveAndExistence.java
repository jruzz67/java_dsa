...
public class RemoveAndExistence<T> {
    ...
    public static void main(String[] args) {
        RemoveAndExistence<String> graph = new RemoveAndExistence<>();
        // Add directed edges
 ...
 * D -> [A]
 * 
 * Does edge A -> B exist? true
 * Does edge B -> A exist? false
 * 
 * After removing edge A -> B:
 * A -> [C]
 * B -> [D]
